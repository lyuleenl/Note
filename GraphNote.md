...
![img](../MarkDownImg/v2-3b93c7ff96ee68c78d3ce03dbf903598_720w.jpg)
...
![img](../MarkDownImg/v2-c01833779ae7a5cbbe72f293347c1cc3_720w.jpg)
...
![img](../MarkDownImg/v2-2663ce7262f59001bc3803b615b6b523_720w.jpg)

## 匈牙利算法

考虑一个下面这个二分图，怎么找到最大的匹配呢？

![img](../MarkDownImg/v2-f4b5a91413f68f07d24337b71f128371_720w.jpg)

一个自然的思路是，一个一个的配对。首先给A配对。一看A和a有意向，那就先把他俩撮合到一起。

现在效果就变成这样了。

![img](../MarkDownImg/v2-f4b5a91413f68f07d24337b71f128371_720w-1609141292395.jpg)
...
![img](../MarkDownImg/v2-3cbbdc96949166ab5ad58989db01eb35_720w.jpg)
...
![img](../MarkDownImg/v2-18e0e6ef3c582ac7aed3840bfac6b222_720w-1609141320470.jpg)
...
b:平衡条件:<u>即流入一个点的流量要等于流出这个点的流量</u>,(源点和汇点除外).
...
![img](../MarkDownImg/v2-8b5fa2fd1102fd52f9ede2efdb19e70c_720w.jpg)
...
![img](../MarkDownImg/v2-7c49281ff50bea41650bb6f5795249c7_720w.jpg)
